        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="edit-info?id=<?php echo $_GET['id']  ?>" enctype="multipart/form-data">
                        <?php if (!empty($err)): ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" value="<?php echo isset($infoData['price_old']) ? htmlspecialchars($infoData['price_old']) : ''; ?>" class="form-control" name="price_old" id="price_old" placeholder="price_old">
                        </div>
