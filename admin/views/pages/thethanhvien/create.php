...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Create thethanhvien</h4>
                    <p class="card-description">
                        Create new thethanhvien
                    </p>
                    <form class="forms-sample" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" value="<?php echo isset($data['day']) ? htmlspecialchars($data['day']) : ''; ?>" class="form-control" name="day" id="day" placeholder="day">
                        </div>
