...
class productController
{
    ...
    public function create() {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($err)) {
                $product = new productModel();
                $product->addProduct($product_name, $price, $price_old,$thumbnail, $status,$id_category);
    ...
    public function edit() {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($err)) {
                $product->editProduct($product_id, $product_name, $price, $price_old,$thumbnail,$status, $id_category);
                header('Location:' . APPURL_ADMIN . 'product');
            }
        }
